...
public class RainbowLikeApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        Post club2 = new Post(member1, board1, "학원 시작하고 엄마를 한 번도 못 봤어요", "엄마보고싶어요", LocalDateTime.now(), 0, "허가", "진행중");
        Post test1 = new Post(member2, board2, "엄마는 나 안 보고 싶을 수도 있어", "사실 그럴 가능성이 더 큰 편이죠", LocalDateTime.now(), 0, "거부", "거부");
