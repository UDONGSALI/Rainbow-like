                        ...
                        <div className={styled.tblScroll}>
                            <div className={styled.tblWrap}>
                                <table className={styled.tbl}>
                                    ...
                                    <tr>
                                        <td><span style={{color: "#000000", letterSpacing: "-1.12px", backgroundColor: "#ffffff"}}>예산 회계, 대관사업 등 </span></td>
                                        <td>정은주</td>
                                        <td><span style={{color: "#000000"}}><span style={{backgroundColor: "#ffffff"}}>주임</span></span></td>
                                        <td>044-863-0380</td>
                                    </tr>
                                    <tr>
